...
public class Address {
    ...
    public static final String MESSAGE_ADDRESS_CONSTRAINTS = "Person addresses MUST be in 'a/123, Clementi Ave 3, #12-34, 231534'.";
    ...
    public Address(String address, boolean isPrivate) throws IllegalValueException {
        ...
        String[] splitaddress = trimmedAddress.split(DELIMITER);
